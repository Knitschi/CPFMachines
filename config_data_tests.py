...
class TestConfigData(unittest.TestCase):
    ...
    def test_reading_the_config_file_works(self):
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[0].default_branch, 'master')
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[0].package_manager, '')
        self.assertEqual( sut.jenkins_config.cpf_job_configs[0].conan_remote, '')
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[1].default_branch, 'master')
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[1].package_manager, '')
        self.assertEqual( sut.jenkins_config.cpf_job_configs[1].conan_remote, '')
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[2].default_branch, 'main')
        ...
        self.assertEqual( sut.jenkins_config.cpf_job_configs[2].package_manager, 'conan')
        self.assertEqual( sut.jenkins_config.cpf_job_configs[2].conan_remote, 'knitschi-conan')
